...
var host = "34.168.51.226";    //from GCloud instance (change to match your db)
var database = "CHEESECAKE";  //database name
var user = "cheese-user";         //username (change to match your db)
var password = "cheese!";  //password (change to match your db, yes this is very poor practice)
